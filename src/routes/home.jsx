...
function Home() {
  ...
  return (
    <section className="bg-theme min-h-[85vh]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-[repeat(autofill, minmax(250px, 1fr))] px-1 gap-1 md:gap-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-[repeat(autofill, minmax(250px, 1fr))] px-1 gap-1">
