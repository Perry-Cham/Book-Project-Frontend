 ...
 */
const ReactViewer = ({ url, viewerLayout, viewerStyle, viewerStyleURL, viewerOption, onBookInfoChange, onPageChange, onTocChange, onSelection, loadingView, }, ref) => {
    ...
    const onResize = useMemo(() => debounce(250, () => {
        ...
        const componentHeight = viewerLayout_.VIEWER_HEADER_HEIGHT +
    ...
    return (<>
      <EpubViewer url={url} style={layoutStyle} bookChanged={bookChanged} rendtionChanged={rendtionChanged} tocChanged={onTocChange} pageChanged={onPageChange} selectionChanged={selectionChanged} loadingView={loadingView || <LoadingView />} ref={ref}/>
    </>);
};
